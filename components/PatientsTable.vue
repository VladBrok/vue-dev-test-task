<template>
  <div v-if="pending" class="mt-8 flex items-center justify-center">
    <Spinner />
  </div>

  <section v-else class="bg-gray-50 p-3 dark:bg-gray-900 sm:p-5">
          ...
          >
            ...
            <tbody>
              ...
              >
                ...
                <td class="max-w-[200px] px-4 py-3">{{ patient.diagnosis }}</td>
                ...
                <td class="flex items-center justify-end px-4 py-3">
                  <button
                    :id="`${patient.id}-dropdown-button`"
                    :data-dropdown-toggle="patient.id"
                  ...
                  <div
                    :id="patient.id"
                    class="z-10 hidden w-44 divide-y divide-gray-100 rounded border-4 border-gray-100 bg-gray-50 shadow-lg dark:divide-gray-600 dark:bg-gray-700"
                  >
                    <ul
                      class="py-1 text-sm text-gray-700 dark:text-gray-200"
                      :aria-labelledby="`${patient.id}-dropdown-button`"
                    >
                      <li>
                        <a
                          href="#"
...
const { data, pending, error } = useFetch("/api/patient"); // TODO: handle error
